...
def listar_archivos(): #Funcion para listar los archivos de Precios
    archivos_precio = []
    c = pathlib.Path(r'/opt/airflow/data/Carga/Entrada/Precios')
...
#DAG de Airflow
with DAG(dag_id='Carga_Incremental_DB',start_date=datetime.datetime(2022,8,25),schedule_interval='@once') as dag:
